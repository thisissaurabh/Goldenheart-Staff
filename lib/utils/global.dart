...
AstrologerSignupModel astrologerUser = AstrologerSignupModel();
...
final List<String> socialMediaLinks = <String>["Youtube", "Facebook","Instagram","Google","Others"];
...
// String agoraAppId = "ba9689cc269d491ca053997fdce16999";
// String agoraAppCertificate = "4106818e64824bf5a911d3c847cacb7f";

// String agoraChannelName = "";
// String agoraToken = "4106818e64824bf5a911d3c847cacb7f";
...
String agoraAppId = "f5df168c9c7849ef892cd39843d1ba42";
String agoraAppCertificate = "e9c2271eafed47d686d609f90feaaf8b";

String agoraChannelName = "sagetalkslive";
String agoraToken = "e9c2271eafed47d686d609f90feaaf8b";
String agoraLiveToken = "";
String channelName = "sagetalkslive";
String agoraLiveChannelName = "";
String liveChannelName = "sagetalkslive";
String agoraChatToken = "";
String agoraChatUserId = "sagetalkslive";
String chatChannelName = "sagetalkslive";


String encodedString = "&&";
String appName = "Goldenheart Staff";
...
//   user = CurrentUser();
//   astrologerUser = AstrologerSignupModel();
...
logoutUser(BuildContext context) async {
  ...
  try {
    // Call the logout API and wait for it to complete
    await apiHelper.logoutapi();

    // Get shared preferences and remove the current user
    sp = await SharedPreferences.getInstance();
    sp!.remove("currentUser");
    log("Current user logout: ${sp!.getString('currentUserId')}");
    ...
    // Optionally, wait for 3 seconds (if you want to show the loading for a bit longer)
    await Future.delayed(const Duration(seconds: 3));
    
    // Hide the loading dialog before navigating away
    LoadingDialog.hideLoading();
    
    // Navigate to the login screen
    Get.offAll(() => LoginScreen());
  } catch (e) {
    // In case of error, hide the loading dialog and show an error message
    LoadingDialog.hideLoading();
    // ScaffoldMessenger.of(context).showSnackBar(
    //   SnackBar(content: Text('Error occurred during logout: $e')),
    // );
  }
}
...
getCurrentUserId() async {
  sp = await SharedPreferences.getInstance();
  CurrentUser userData =
      CurrentUser.fromJson(json.decode(sp!.getString("currentUser") ?? ""));currentUserId = userData.id;
}
...
//       link: Uri.parse(
//           "https://astrokalp.page.link/userProfile?screen=dailyHorscope"),
//       androidParameters: const AndroidParameters(
//         packageName: 'com.astrokalp.astrologer',
//         minimumVersion: 1,
//       ),
//     );
//     Uri url;
